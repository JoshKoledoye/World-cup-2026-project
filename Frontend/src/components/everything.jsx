...
void main() {
  ...
  return (
    <>
     ...
     {/* FOOTER BAR */}
      <footer
        className="bg-primary-container dark:bg-blue-900 w-full px-margin-mobile md:px-margin-desktop py-lg flex flex-col md:flex-row justify-between items-center gap-md border-t border-outline-variant"
